...
# Configurando Merkle Proof

Ahora vamos a crear una función para generar el merkle proof. Primero debemos instalar las siguientes librerias desde la terminal keccak256 y merkletreejs:

```bash
npm install keccak256 merkletreejs
```

Y creamos un archivo llamado merkleTree.ts dentro de la carpeta utils, donde definiremos la logica del merkle tree:
